class ProfilesController < ApplicationController
  before_action :authenticate_user! #Only logged in users can view profiles
  ...
  private
    ...
    def only_current_user #Current user can ONLY create or edit profile for themselves.
      @user = User.find( params[:user_id] )
